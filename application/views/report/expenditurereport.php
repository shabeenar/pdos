<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?php echo base_url('report/ViewExpenditureReport/add_report') ?>" method="post">
                <div class="row">

                    <div class="form-group col-md-6">
                        <label for="cus_address">From Date</label>
                        <input type="date" class="form-control" name="from" id="from" max="<?php echo date('Y-m-d'); ?>">
                    </div>
