                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" action="<?php echo base_url('login/login/signup'); ?>" method="post" data-toggle="validator">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" name="password" id="password" placeholder="Password" minlength="6" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                ...
                                <div class="copyright text-center my-auto">
                                    <span><small>Copyright &copy; <?php echo date("Y"); ?> Patient Diet Ordering System for Colombo South Teaching Hospital<small> </span>
                                </div>
                            </div>
                        </div>
                    </div>
