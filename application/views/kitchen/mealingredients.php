...
<?php if ($ingredients) { ?>
        <a type="button" class="btn btn-success" href="<?php base_url()?>AddIngredient?id=<?php echo $ingredients[0]->id; ?>">Add Ingredients</a>
<?php } else { ?>
        <a type="button" class="btn btn-success" href="<?php base_url()?>AddIngredient?id=<?php echo $meals[0]->id; ?>">Add Ingredients</a>
<?php } ?>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" id="meal" name="meal" value="<?php echo $meals[0]->meal_name; ?>" readonly>
            ...
            <table class="table table-bordered" id="meal_ingredients_table">
                ...
                <?php foreach ($ingredients as $ingredient) { ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-warning btn-sm" href="<?php base_url()?>ViewIngredients?id=<?php echo $ingredient->id; ?>">View Ingredients</a>

                            <form action="<?php echo base_url('kitchen/ViewIngredients/confirm_ingredients'); ?>" method="post">

                                <?php if ($ingredient->status == 1) { ?>
                                    <input type="hidden" id="id" name="id" value="<?php echo $ingredient->id; ?>">
