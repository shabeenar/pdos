...
<div class="container-fluid">
    <ol class="breadcrumb mb-4 mt-2">
        ...
        <li class="breadcrumb-item active">Item Category Management</li>
    </ol>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="update_itemcategory_modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!--  add new form to modal-->
            <form action="<?php echo base_url('item/itemcategory/update_itemcategory'); ?>" method="post" data-toggle="validator">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Code</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="update_category_code" name="code" required>
                            <div class="help-block with-errors"></div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="update_category_name" name="name" required>
                            <div class="help-block with-errors"></div>
